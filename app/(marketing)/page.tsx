  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFF8F0]">
      ...
      <header className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto w-full">
        <span className="md:text-2xl text-xl font-bold tracking-tight">
          Scope<span className="text-[#2EC4B6]">It</span>
        </span>
        <div className="flex items-center gap-3">
          <Link
            href="/app"
            className="text-sm font-medium text-[#0D1B2A] px-5 py-2.5 rounded-lg border border-[#D4CFC7] hover:border-[#0D1B2A] transition-colors duration-200 hidden md:block"
          >
            Sign In
          </Link>
          <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center">
            <div className="w-full aspect-square max-w-md bg-[#2EC4B6]/8 rounded-3xl border-2 border-dashed border-[#2EC4B6]/30 flex flex-col items-center justify-center gap-4 p-8">
              ...
              {/* Chaos → Clarity visual placeholder */}
